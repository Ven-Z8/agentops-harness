...
class Planner:
    ...
    def create_plan(self, task: str, repo_profile: RepoProfile) -> ImplementationPlan:
        if self.llm_client is not None:
            return self.llm_client.generate_structured(
                self._build_prompt(task, repo_profile),
                ImplementationPlan,
            )
    ...
    def _build_prompt(self, task: str, repo_profile: RepoProfile) -> str:
        framework = self._display_framework(repo_profile.framework or repo_profile.language)
